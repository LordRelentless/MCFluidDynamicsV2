...
public class MCFluidDynamicsV2Mod {
    ...
    public static final net.neoforged.neoforge.capabilities.CapabilityToken<IWorldFluidIndex> FLUID_INDEX_CAP = new net.neoforged.neoforge.capabilities.CapabilityToken<>() {};
