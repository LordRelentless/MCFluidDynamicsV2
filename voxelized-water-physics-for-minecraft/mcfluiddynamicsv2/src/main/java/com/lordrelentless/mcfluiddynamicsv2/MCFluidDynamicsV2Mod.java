...
import com.lordrelentless.mcfluiddynamicsv2.client.ClientHandler;
...
public class MCFluidDynamicsV2Mod {
    ...
    public static final RegistryObject<Block> COLORED_SOLID_BLOCK = BLOCKS.register("colored_solid", ColoredSolidBlock::new);
    public static final RegistryObject<Block> FLUID_VOXEL_BLOCK = BLOCKS.register("fluid_voxel", FluidVoxelBlock::new);
    public static final RegistryObject<BlockEntityType<FluidVoxelBlockEntity>> FLUID_VOXEL_BE_TYPE = BE_TYPES.register("fluid_voxel", () -> 
        BlockEntityType.Builder.of(FluidVoxelBlockEntity::new, FLUID_VOXEL_BLOCK.get()).build(null));

    public static final nepublic static final net.neoforged.neoforge.capabilities.CapabilityToken<IWorldFluidIndex> FLUID_INDEX_CAP =
        new net.neoforged.neoforge.capabilities.CapabilityToken<>() {};t.neoforged.neoforge.capabilities.CapabilityToken<IWorldFluidIndex> FLUID_INDEX_CAP = new net.neoforged.neoforge.capabilities.CapabilityToken<>() {};
